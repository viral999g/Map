import pymongo, json, operator, xlrd
...
file3 = open('/media/viral999g/G/Projects/Map/Input/castedata.csv', 'r').readlines()
...
#     columns = row.split(',')
#     location_id = columns[1]
#     caste_name = columns[4]

#     if location_id in data3:
#         if caste_name in data3[location_id]:
#             data3[location_id][caste_name] += 1
#         else:
#             data3[location_id][caste_name] = 1
#     else:
#         data3[location_id] = {caste_name : 1}
